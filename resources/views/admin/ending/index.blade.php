        ...
        <div role="tabpanel" class="tab-pane fade in active" id="entities">
            ...
            <div class="row">
                <div class="col-md-12 text-right ">
                    <a class="btn btn-primary btn-3d btn-reveal btn-form" href="/admin/endings/create"><i class="fa fa-plus-circle"></i> <span>ADD ENDING</span></a>
                </div>
            </div>
            ...
            <div id="admin-results" data-href="{{ url('admin/endings/list') }}"></div>

        </div>

        <div role="tabpanel" class="tab-pane fade" id="categories">

            @include('admin.endinggroup.index')
